...
def test_demo_tables_exist_with_demo_only_naming():
    sql = _migration_sql()
...
def test_demo_interactions_enforce_canonical_pair_and_fk_guards():
    sql = _migration_sql()
...
def test_demo_contract_contains_helper_rpcs_for_profile_interaction_map_reads():
    sql = _migration_sql()
