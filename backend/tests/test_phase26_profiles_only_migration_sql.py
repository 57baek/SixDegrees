...
def test_phase26_declares_preflight_function_for_staging_gate():
    sql = _migration_sql()
...
def test_phase26_drop_guard_fails_closed_before_drop():
    sql = _migration_sql()
...
def test_phase26_runs_preflight_before_reset_and_drop():
    sql = _migration_sql()
...
def test_phase26_dependency_scans_cover_fk_view_and_function_catalog_paths():
    sql = _migration_sql()
...
def test_phase26_reset_notice_requires_republish_of_fresh_global_version():
    sql = _migration_sql()
